...
const TAndC = () => {
    return (
        <div className='tc p-6 flex gap-8 items-center'>

            <div className="delivery flex flex-col flex-nowrap overflow-auto items-center gap-2 w-45 h-35 border-1 p-4 rounded-lg">
                ...
                <h3 className='font-bold text-lg text-center'>Free Delivery on order above 50000</h3>
            </div>

            <div className="cash flex flex-col flex-nowrap overflow-auto items-center gap-2 w-45 h-35 border-1 p-4 rounded-lg ">
                ...
                <h3 className='font-bold text-lg text-center'>Cash on Delivery Available</h3>
            </div>

            <div className="secure flex flex-col flex-nowrap overflow-auto items-center gap-2 w-45 h-35 border-1 p-4 rounded-lg ">
                ...
                <h3 className='font-bold text-lg text-center'>Secure Payment Gateway</h3>
            </div>

            <div className="support flex flex-col flex-nowrap overflow-auto items-center gap-2 w-45 h-35 border-1 p-4 rounded-lg ">
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 4h1.5L9 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-8.5-3h9.25L19 7H7.312" />
                </svg>
                <h3 className='font-bold text-lg text-center'>24/7 Customer Support</h3>
            </div>
        </div>
    )
}
